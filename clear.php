...
if (isset($_SESSION["adminname"])) {
    ...
    $pd = $rowpass["password"];
    $tablename = "studenttable";  //table name which is to be truncate
    $truncateq = "DELETE from $tablename"; //truncate query
    if ($password == $pd) {
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal  content" action="clear.php" method="post" role="form">
                            <div class="form-group">
                                <p>
                                <h3>Do you really want to clear all seating arrangement ?</h3></p>
                                ...
                                <label>Password :</label><input class="form-control" type="password"
                                                                name="password"></input>
                                <!--password is enter here for all input data clearing-->
                            </div>

                            <center><input type="submit" name="clear" value="clear"
                                           class="btn btn-lg btn-warning"></input>
                            </center>
                        </form>
