...
if ($conn) {
    if (isset($_POST['submit'])) {
        ...
        // New
        $query = mysqli_query($conn, "SELECT * FROM admintable WHERE adminname='$adminname' AND password='$password'");
...
<div class="wrapper">
    <center>
        <img src="images/Administrator Male-52.png" hspace="20" height="120" width="120"/></center>
    <form class="admin-signin" method="post" action="<?php $_PHP_SELF ?>">
       ...
       <span>
        ...
        <a href="forgotpassowrd.php"><b> </b></a></h5>
      </span>
